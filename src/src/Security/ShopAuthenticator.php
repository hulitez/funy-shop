...
class ShopAuthenticator extends AbstractFormLoginAuthenticator implements PasswordAuthenticatedInterface
{
    use TargetPathTrait;
    ...
    public function getCredentials(Request $request)
    {
        ...
        if (empty($credentials['password'])) {
            throw new CustomUserMessageAuthenticationException('password could not be empty.');
        }
